...
const ParentSidebar = () => {
  ...
  const navItems = [
    ...
    { title: "My Children", href: "/parent-dashboard?tab=children", icon: Users },
    { title: "Activity Log", href: "/parent-dashboard?tab=activity", icon: Activity },
    { title: "Achievements", href: "/parent-dashboard?tab=badges", icon: Award },
